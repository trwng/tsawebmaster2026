...
const Submit_Resources = () => {
  ...
  if (submitted) {
    return (
      <main className="w-full min-h-[75vh] flex items-center justify-center px-4 mt-16 sm:mt-20">
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 text-center max-w-2xl w-full border border-gray-100">
